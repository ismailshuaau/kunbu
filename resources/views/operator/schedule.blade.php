  ...
  <nav class="z-depth-3">
    <div class="nav-wrapper">
      ...
      <ul class="side-nav fixed" id="mobile-demo">
        ...
        <li class="active"><a href="schedule"><i class="material-icons">event</i>Schedule</a></li>
  ...
  <nav class="grey darken-2 nav-breadcrumb">
    <div class="nav-wrapper side-nav-margin-left-on-large margin-left-10-m">
      <div class="col s12">
        ...
        <a href="#!" class="breadcrumb">Schedule</a>
      </div>
    </div>
  </nav>
          ...
          <table class="highlight responsive-table">
            <thead>
              <tr>
                  ...
                  <th data-field="desc">Starts On</th>
                  <th data-field="reg">Price</th>
                  <th data-field="seats">No. of Routes</th>
            ...
            <tbody>
              @foreach ($schedules as $schedule)
                <tr>
                  ...
                  <td>{{ count($schedule->routes) }}</td>
                  <td>
                    <button class="btn-floating waves-effect waves-light cyan darken-2 tooltipped" data-position="bottom" data-delay="50" data-tooltip="View Routes" onclick="loadRoutes({{ $schedule->id }})"><i class="material-icons">list</i></button>
                    <a class="btn-floating btn-small waves-effect waves-light green darken-2 tooltipped" data-position="bottom" data-delay="50" data-tooltip="New Route" onclick="newRoute({{ $schedule->id }})"><i class="material-icons">add</i></a>
                      <a class="btn-floating btn-small waves-effect waves-light deep-orange darken-2 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Delete Vessel" onclick="deleteEntity({{ $schedule->id }})"><i class="material-icons">delete</i></a></td>
                </tr>
              @endforeach
            </tbody>
          </table>
  ...
  <div id="modalCreateSlide" class="modal modal-fixed-footer">
    <div class="modal-content">
      ...
      <form id="formCreateSlide" method="post" action="schedule/createroute" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="input-field col s12">
            <select placeholder="Select Island" id="island" name="island">
              <option value="" disabled selected>Choose your option</option>
