  ...
  <nav class="z-depth-3">
    <div class="nav-wrapper">
      ...
      <ul class="side-nav fixed" id="mobile-demo">
        ...
        <li class="active"><a href="hire"><i class="material-icons">star</i>Hire</a></li>
  ...
  <nav class="grey darken-2 nav-breadcrumb">
    <div class="nav-wrapper side-nav-margin-left-on-large margin-left-10-m">
      <div class="col s12">
        ...
        <a href="#!" class="breadcrumb">Hire</a>
      </div>
    </div>
  </nav>

  <div class="fixed-action-btn">
    <a class="btn-floating btn-large cyan darken-3 hoverable tooltipped modal-trigger" data-position="left" data-delay="50" data-tooltip="New Ticket" href="#createNewVessel">
          ...
          <table class="highlight responsive-table">
            <thead>
              <tr>
                  ...
                  <th data-field="deptime">Dep. Time</th>
